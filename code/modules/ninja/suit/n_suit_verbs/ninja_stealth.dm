...
/obj/item/clothing/suit/space/space_ninja/proc/toggle_stealth()
	...
	if(s_active)
		...
		if(cell.charge <= 0)
			U.text2tab("<span class='warning'>You don't have enough power to enable Stealth!</span>")
			return
		s_active=!s_active
...
/obj/item/clothing/suit/space/space_ninja/proc/stealth()
	...
	if(!s_busy)
		...
		affecting.text2tab("<span class='danger'>Stealth does not appear to work!</span>")
