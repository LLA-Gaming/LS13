...
/client/verb/toggle_space_parallax()
	...
	if(!prefs.space_parallax)
		text2tab("Space parallax is now deactivated.")
	else
		text2tab("Space parallax is now activated.")
...
/client/verb/toggle_space_dust()
	...
	if(!prefs.space_dust)
		text2tab("Space dust is now deactivated.")
	else
		text2tab("Space dust is now activated.")
