...
/obj/machinery/chem_dispenser/emag_act(mob/user)
	if(emagged)
		user.text2tab("<span class='warning'>\The [src] has no functional safeties to emag.</span>")
		return
	user.text2tab("<span class='notice'>You short out \the [src]'s safeties.</span>")
...
/obj/machinery/chem_dispenser/attackby(obj/item/I, mob/user, params)
	...
	if(istype(I, /obj/item/weapon/reagent_containers) && (I.flags & OPENCONTAINER))
		...
		beaker = B
		beaker.loc = src
		user.text2tab("<span class='notice'>You add \the [B] to the machine.</span>")
		...
		user.text2tab("<span class='warning'>You can't load \the [I] into the machine!</span>")
	else
		return ..()
