...
/datum/reagent/toxin/slimejelly/on_mob_life(mob/living/M)
	if(prob(10))
		M.text2tab("<span class='danger'>Your insides are burning!</span>")
...
/datum/reagent/toxin/histamine/on_mob_life(mob/living/M)
	if(prob(50))
		switch(pick(1, 2, 3, 4))
			if(1)
				M.text2tab("<span class='danger'>You can barely see!</span>")
				M.blur_eyes(3)
			if(2)
				M.emote("cough")
			if(3)
			...
			if(4)
				if(prob(75))
					M.text2tab("You scratch at an itch.")
...
/datum/reagent/toxin/cyanide/on_mob_life(mob/living/M)
	if(prob(5))
		M.losebreath += 1
	if(prob(8))
		M.text2tab("You feel horrendously weak!")
		M.Stun(2, 0)
		M.adjustToxLoss(2*REM, 0)
	return ..()
...
/datum/reagent/toxin/itching_powder/on_mob_life(mob/living/M)
	if(prob(15))
		M.text2tab("You scratch at your head.")
		M.adjustBruteLoss(0.2*REM, 0)
		. = 1
	if(prob(15))
		M.text2tab("You scratch at your leg.")
		M.adjustBruteLoss(0.2*REM, 0)
		. = 1
	if(prob(15))
		M.text2tab("You scratch at your arm.")
		M.adjustBruteLoss(0.2*REM, 0)
		. = 1
	if(prob(3))
...
/datum/reagent/toxin/peaceborg/confuse/on_mob_life(mob/living/M)
	...
	M.Dizzy(1)
	if(prob(20))
		M.text2tab("You feel confused and disorientated.")
	..()
...
/datum/reagent/toxin/peaceborg/tire/on_mob_life(mob/living/M)
	...
	if(prob(30))
		M.text2tab("You should sit down and take a rest...")
	..()
