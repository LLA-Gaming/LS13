...
/datum/reagent/drug/space_drugs/overdose_start(mob/living/M)
	M.text2tab("<span class='userdanger'>You start tripping hard!</span>")
...
/datum/reagent/drug/nicotine/on_mob_life(mob/living/M)
	if(prob(1))
		...
		M.text2tab("<span class='notice'>[smoke_message]</span>")
	M.AdjustStunned(-1, 0)
...
/datum/reagent/drug/crank/on_mob_life(mob/living/M)
	...
	if(prob(5))
		M.text2tab("<span class='notice'>[high_message]</span>")
...
/datum/reagent/krokodil/addiction_act_stage2(mob/living/M)
	if(prob(25))
		M.text2tab("<span class='danger'>Your skin feels loose...</span>")
	..()

/datum/reagent/drug/krokodil/addiction_act_stage3(mob/living/M)
	if(prob(25))
		M.text2tab("<span class='danger'>Your skin starts to peel away...</span>")
...
/datum/reagent/drug/krokodil/addiction_act_stage4(mob/living/carbon/human/M)
	...
	if(!istype(M.dna.species, /datum/species/krokodil_addict))
		M.text2tab("<span class='userdanger'>Your skin falls off easily!</span>")
