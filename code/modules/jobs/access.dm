...
/var/const/access_therapy = 67
/var/const/access_pcommander = 68
/var/const/access_penforcer = 69
...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(3) //medbay
			return list(access_medical, access_genetics, access_morgue, access_chemistry, access_virology, access_surgery, access_therapy, access_cmo)
		if(4) //research
...
/proc/get_all_jobs()
	return list("Assistant", "Station Chief", "Head of Personnel", "Bartender", "Cook", "Botanist", "Quartermaster", "Cargo Technician",
