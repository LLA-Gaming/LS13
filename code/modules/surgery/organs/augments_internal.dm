...
/obj/item/organ/cyberimp/brain/emp_act(severity)
	...
	owner.text2tab("<span class='warning'>Your body seizes up!</span>")
	return stun_amount
...
/obj/item/organ/cyberimp/brain/anti_drop/ui_action_click()
	...
	if(active)
		...
		if(!l_hand_obj && !r_hand_obj)
			owner.text2tab("<span class='notice'>You are not holding any items, your hands relax...</span>")
			active = 0
		else
			var/msg = 0
			...
			switch(msg)
				if(1)
					owner.text2tab("<span class='notice'>Your left hand's grip tightens.</span>")
				if(2)
					owner.text2tab("<span class='notice'>Your right hand's grip tightens.</span>")
				if(3)
					owner.text2tab("<span class='notice'>Both of your hand's grips tighten.</span>")
	else
		release_items()
		owner.text2tab("<span class='notice'>Your hands relax...</span>")
		l_hand_obj = null
		r_hand_obj = null
...
/obj/item/organ/cyberimp/brain/anti_drop/emp_act(severity)
	...
	if(L_item)
		...
		owner.text2tab("<span class='warning'>Your left arm spasms and throws the [L_item.name]!</span>")
	if(R_item)
		A = pick(oview(range))
		R_item.throw_at(A, range, 2)
		owner.text2tab("<span class='warning'>Your right arm spasms and throws the [R_item.name]!</span>")
...
/obj/item/organ/cyberimp/mouth/breathing_tube/emp_act(severity)
	if(prob(60/severity))
		owner.text2tab("<span class='warning'>Your breathing tube suddenly closes!</span>")
		owner.losebreath += 2
