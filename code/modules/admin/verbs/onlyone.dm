/client/proc/only_one()
	...
	for(var/mob/living/carbon/human/H in player_list)
		...
		H.text2tab("<B>You are the traitor.</B>")
		var/obj_count = 1
		...
		H.equip_to_slot_or_del(new /obj/item/device/radio/headset/heads/manager(H), slot_ears)
...
/proc/only_me()
	...
	for(var/mob/living/carbon/human/H in player_list)
		...
		H.text2tab("<B>You are the multiverse summoner. Activate your blade to summon copies of yourself from another universe to fight by your side.</B>")
		var/obj_count = 1
		for(var/datum/objective/OBJ in H.mind.objectives)
			H.text2tab("<B>Objective #[obj_count]</B>: [OBJ.explanation_text]")
			obj_count++
