...
/obj/item/weapon/gun/grenadelauncher/examine(mob/user)
	..()
	user.text2tab("[grenades.len] / [max_grenades] grenades loaded.")
...
/obj/item/weapon/gun/grenadelauncher/attackby(obj/item/I, mob/user, params)
	...
	if((istype(I, /obj/item/weapon/grenade)))
		if(grenades.len < max_grenades)
			...
			I.loc = src
			grenades += I
			user.text2tab("<span class='notice'>You put the grenade in the grenade launcher.</span>")
			user.text2tab("<span class='notice'>[grenades.len] / [max_grenades] Grenades.</span>")
		else
			usr.text2tab("<span class='danger'>The grenade launcher cannot hold more grenades.</span>")
...
/obj/item/weapon/gun/grenadelauncher/afterattack(obj/target, mob/user , flag)
	...
	if(grenades.len)
		...
		usr.text2tab("<span class='danger'>The grenade launcher is empty.</span>")
