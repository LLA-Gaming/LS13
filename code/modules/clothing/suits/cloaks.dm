...
/obj/item/clothing/suit/cloak/ce
	name = "head atmospheric engineer's cloak"
...
/obj/item/clothing/suit/cloak/cap
	name = "station chief's cloak"
	desc = "Worn by the chief of Ice Station Zebra."
	icon_state = "capcloak"
...
/obj/item/clothing/cloak/wizard/proc/toggleInvisibility(mob/user)
	if(user.slot_back != src)
		user.text2tab("<span class='warning'>You need to be wearing the cloak first!</span>")
		return
