...
/obj/item/organ/alien/hivenode/proc/queen_death()
	...
	if(isalien(owner)) //Different effects for aliens than humans
		owner.text2tab("<span class='userdanger'>Your Queen has been struck down!</span>")
		owner.text2tab("<span class='danger'>You are struck with overwhelming agony! You feel confused, and your connection to the hivemind is severed.")
		owner.emote("roar")
		owner.Stun(10) //Actually just slows them down a bit.

	else if(ishuman(owner)) //Humans, being more fragile, are more overwhelmed by the mental backlash.
		owner.text2tab("<span class='danger'>You feel a splitting pain in your head, and are struck with a wave of nausea. You cannot hear the hivemind anymore!")
		owner.emote("scream")
		owner.Weaken(5)
	...
	spawn(2400) //four minutes
		...
		if(!owner) //In case the xeno is butchered or subjected to surgery after death.
			return
		owner.text2tab("<span class='noticealien'>The pain of the queen's death is easing. You begin to hear the hivemind again.</span>")
