...
/mob/living/silicon/pai/emp_act(severity)
	...
	src.text2tab("<span class ='warning'>Communication circuit overload. Shutting down and reloading communication circuits - speech and messaging functionality will be unavailable until the reboot is complete.</span>")

	switch(pick(1,2,3))
		if(1)
			src.master = null
			src.master_dna = null
			src.text2tab("<span class='notice'>You feel unbound.</span>")
		if(2)
			var/command
			if(severity  == 1)
			...
			src.text2tab("<span class='notice'>Pr1m3 d1r3c71v3 uPd473D.</span>")
		if(3)
			src.text2tab("<span class='notice'>You feel an electric surge run through your circuitry and become acutely aware at how lucky you are that you can still feel at all.</span>")
