...
/mob/living/simple_animal/drone/verb/toggle_light()
	...
	src.text2tab("<span class='notice'>Your light is now [light_on ? "on" : "off"].</span>")
...
/mob/living/simple_animal/drone/verb/toggle_statics()
	...
	if(!seeStatic)
		src.text2tab("<span class='warning'>You have no vision filter to change!</span>")
		return
