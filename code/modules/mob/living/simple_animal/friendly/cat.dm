...
/mob/living/simple_animal/pet/cat/cak/CheckParts(list/parts)
	...
	src.text2tab("<font size=3><b>Y</b></font><b>ou are a cak! You're a harmless cat/cake hybrid that everyone loves. People can take bites out of you if they're hungry, but you regenerate health \
	...
	if(new_name)
		src.text2tab("<span class='notice'>Your name is now <b>\"new_name\"</b>!</span>")
		name = new_name
