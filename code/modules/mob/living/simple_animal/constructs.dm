...
/mob/living/simple_animal/hostile/construct/attack_animal(mob/living/simple_animal/M)
	if(istype(M, /mob/living/simple_animal/hostile/construct/builder))
		if(health < maxHealth)
			...
			if(src != M)
				M.text2tab("<span class='cult'>You cannot repair <b>[src]'s</b> dents, as it has none!</span>")
			else
				M.text2tab("<span class='cult'>You cannot repair your own dents, as you have none!</span>")
	else if(src != M)
		..()
