...
/obj/item/weapon/reagent_containers/food/snacks/grown/potato/attackby(obj/item/weapon/W, mob/user, params)
	...
	if(istype(W, /obj/item/stack/cable_coil))
		...
		if (C.use(5))
			user.text2tab("<span class='notice'>You add some cable to the potato and slide it inside the battery encasing.</span>")
			...
			user.text2tab("<span class='warning'>You need five lengths of cable to make a potato battery!</span>")
			return
