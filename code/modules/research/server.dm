...
/obj/machinery/computer/rdservercontrol/Topic(href, href_list)
	...
	if(!src.allowed(usr) && !emagged)
		usr.text2tab("<span class='danger'>You do not have the required access level.</span>")
		return
...
/obj/machinery/computer/rdservercontrol/emag_act(mob/user)
	if(!emagged)
		...
		emagged = 1
		user.text2tab("<span class='notice'>You you disable the security protocols.</span>")
