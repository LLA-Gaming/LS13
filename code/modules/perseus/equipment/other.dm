...
/obj/item/weapon/tank/internals/perseus
	...
	New()
		...
		air_contents.gases["o2"][MOLES] = (10*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C)
		return
/*
* Jet harness
*/
...
/obj/structure/stimtank/perseus
	...
	New()
		...
		reagents.add_reagent("ephedrine", 500)
...
/obj/item/weapon/grenade/plastic/c4/breach
...
/obj/structure/displaycase/perseus
	...
	start_showpiece_type = /obj/item/weapon/gun/projectile/automatic/fiveseven
	density = 0

	update_icon()
		icon_state = "pglassbox[destroyed ? "b" : ""][showpiece != null]"
