...
/datum/action/neck_chop/Trigger()
	if(owner.incapacitated())
		owner.text2tab("<span class='warning'>You can't use Krav Maga while you're incapacitated.</span>")
		return
...
/datum/martial_art/krav_maga/teach(var/mob/living/carbon/human/H,var/make_temporary=0)
	..()
	H.text2tab("<span class = 'userdanger'>You know the arts of Krav Maga!</span>")
...
/datum/martial_art/krav_maga/remove(var/mob/living/carbon/human/H)
	..()
	H.text2tab("<span class = 'userdanger'>You suddenly forget the arts of Krav Maga...</span>")
	neckchop.Remove(H)
	legsweep.Remove(H)
	lungpunch.Remove(H)
