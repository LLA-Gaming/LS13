...
/datum/symptom/weakness/Activate(datum/disease/advance/A)
	...
	if(prob(SYMPTOM_ACTIVATION_PROB))
		...
		switch(A.stage)
			if(1, 2)
				M.text2tab("<span class='warning'>[pick("You feel weak.", "You feel lazy.")]</span>")
			if(3, 4)
				M.text2tab("<span class='warning'><b>[pick("You feel very frail.", "You think you might faint.")]</span>")
				M.adjustStaminaLoss(15)
			else
				M.text2tab("<span class='userdanger'>[pick("You feel tremendously weak!", "Your body trembles as exhaustion creeps over you.")]</span>")
