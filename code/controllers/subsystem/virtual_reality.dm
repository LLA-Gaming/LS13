var/datum/subsystem/virtual_reality/SSvirtual_reality

/datum/subsystem/virtual_reality
	...
	New()
		NEW_SS_GLOBAL(SSvirtual_reality)
	...
	proc/CreateMob(var/mob/living/carbon/human/H, var/glasses_type)
		...
		if(istype(H.ears, /obj/item/device/radio/headset))
			...
			if(headset.keyslot) keyslot = headset.keyslot.type
		...
		if(has_headset)
			...
			if(keyslot) virtual_headset.keyslot = new keyslot(virtual_headset)
