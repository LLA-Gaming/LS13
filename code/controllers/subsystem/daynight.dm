...
/datum/subsystem/daynight
	...
	var/list/times_of_day = list(
		...
		list("name" = "7 PM",     "alpha" = 180),
		list("name" = "8 PM",     "alpha" = 105),
		list("name" = "9 PM",     "alpha" = 55),
		list("name" = "10 PM",    "alpha" = 0),
		list("name" = "11 PM",    "alpha" = 0),
		list("name" = "MIDNIGHT", "alpha" = 0),
		list("name" = "1 AM",     "alpha" = 0),
		list("name" = "2 AM",     "alpha" = 50),
		list("name" = "3 AM",     "alpha" = 100),
		list("name" = "4 AM",     "alpha" = 150),
		list("name" = "5 AM",     "alpha" = 200))
