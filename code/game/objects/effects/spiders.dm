...
/obj/effect/spider/stickyweb/CanPass(atom/movable/mover, turf/target, height=0)
	...
	if(istype(mover, /mob/living/simple_animal/hostile/poison/giant_spider))
		...
		if(prob(50))
			mover:text2tab("<span class='danger'>You get stuck in \the [src] for a moment.</span>")
			return 0
...
/obj/effect/spider/cocoon/container_resist()
	...
	user.text2tab("<span class='notice'>You struggle against the tight bonds... (This will take about [breakout_time] minutes.)</span>")
