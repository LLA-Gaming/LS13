...
/obj/effect/mine/proc/mineEffect(mob/victim)
	victim.text2tab("<span class='danger'>*click*</span>")
...
/obj/effect/mine/kickmine/mineEffect(mob/victim)
	if(isliving(victim) && victim.client)
		victim.text2tab("<span class='userdanger'>You have been kicked FOR NO REISIN!</span>")
		del(victim.client)
...
/obj/effect/mine/pickup/bloodbath/mineEffect(mob/living/carbon/victim)
	if(!victim.client || !istype(victim))
		return
	victim.text2tab("<span class='reallybig redtext'>KILL EM ALL</span>")
	...
	sleep(duration)
	victim.text2tab("<span class='notice'>You feel calm again.<span>")
	qdel(chainsaw)
	qdel(src)
...
/obj/effect/mine/pickup/healing/mineEffect(mob/living/carbon/victim)
	if(!victim.client || !istype(victim))
		return
	victim.text2tab("<span class='notice'>You feel great!</span>")
...
/obj/effect/mine/pickup/speed/mineEffect(mob/living/carbon/victim)
	if(!victim.client || !istype(victim))
		return
	victim.text2tab("<span class='notice'>You feel fast!</span>")
	victim.status_flags |= GOTTAGOREALLYFAST
	sleep(duration)
	victim.status_flags &= ~GOTTAGOREALLYFAST
	victim.text2tab("<span class='notice'>You slow down.</span>")
