...
/obj/item/weapon/banhammer/attack(mob/M, mob/user)
	M.text2tab("<font color='red'><b> You have been banned FOR NO REISIN by [user]<b></font>")
	user.text2tab("<font color='red'>You have <b>BANNED</b> [M]</font>")
...
/obj/item/weapon/wirerod/attackby(obj/item/I, mob/user, params)
	if(istype(I, /obj/item/weapon/shard))
		...
		user.put_in_hands(S)
		user.text2tab("<span class='notice'>You fasten the glass shard to the top of the rod with the cable.</span>")
		qdel(I)
		qdel(src)
		...
		user.put_in_hands(P)
		user.text2tab("<span class='notice'>You fasten [I] to the top of the rod with the cable.</span>")
		qdel(I)
		qdel(src)
	else
		return ..()
