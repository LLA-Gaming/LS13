...
/datum/game_mode/gang
	...
	restricted_jobs = list("Security Officer", "Warden", "Detective", "AI", "Cyborg","Station Chief", "Human Resources", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer")
	required_players = 18
	required_enemies = 2
