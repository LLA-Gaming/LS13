...
/datum/game_mode/monkey/proc/greet_carrier(datum/mind/carrier)
	carrier.current.text2tab("<B><span class='notice'>You are the Jungle Fever patient zero!!</B>")
	carrier.current.text2tab("<b>You have been planted onto this station by the Animal Rights Consortium.</b>")
	carrier.current.text2tab("<b>Soon the disease will transform you into an ape. Afterwards, you will be able spread the infection to others with a bite.</b>")
	carrier.current.text2tab("<b>While your infection strain is undetectable by scanners, any other infectees will show up on medical equipment.</b>")
	carrier.current.text2tab("<b>Your mission will be deemed a success if any of the live infected monkeys reach Centcom.</b>")
	return
