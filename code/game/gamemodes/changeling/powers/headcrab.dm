...
/obj/effect/proc_holder/changeling/headcrab/sting_action(mob/user)
	...
	for(var/mob/living/carbon/human/H in range(2,user))
		H.text2tab("<span class='userdanger'>You are blinded by a shower of blood!</span>")
		H.Stun(1)
		H.blur_eyes(20)
		H.adjust_eye_damage(5)
		H.confused += 3
	for(var/mob/living/silicon/S in range(2,user))
		S.text2tab("<span class='userdanger'>Your sensors are disabled by a shower of blood!</span>")
		S.Weaken(3)
	...
	spawn(5) // So it's not killed in explosion
		...
		if(crab.origin)
			...
			crab.text2tab("<span class='warning'>You burst out of the remains of your former body in a shower of gore!</span>")
	user.gib()
