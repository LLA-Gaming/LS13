...
/datum/action/innate/function_call/Activate()
	if(owner.l_hand && owner.r_hand)
		usr.text2tab("<span class='warning'>You need an empty to hand to call forth your spear!</span>")
		return 0
...
/atom/movable/proc/procure_gateway(mob/living/invoker, time_duration, gateway_uses, two_way)
	...
	if(!possible_targets.len)
		invoker.text2tab("<span class='warning'>There are no other eligible targets for a Spatial Gateway!</span>")
		return 0
