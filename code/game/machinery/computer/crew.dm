...
/datum/crewmonitor/New()
	...
	jobs["Station Chief"] = 00
	jobs["Human Resources"] = 50
	jobs["Head of Security"] = 10
	jobs["Warden"] = 11
	jobs["Security Officer"] = 12
	jobs["Detective"] = 13
	jobs["Medical Director"] = 20
	jobs["Chemist"] = 21
	jobs["Geneticist"] = 22
	jobs["Virologist"] = 23
	jobs["Medical Doctor"] = 24
	jobs["Lead Scientist"] = 30
	jobs["Scientist"] = 31
	jobs["Mechanic"] = 32
	jobs["Head Atmospheric Engineer"] = 40
	jobs["Atmospheric Engineer"] = 42
	jobs["Quartermaster"] = 51
	jobs["Mining Technician"] = 52
	jobs["Supply Technician"] = 53
	jobs["Bartender"] = 61
	jobs["Chef"] = 62
	jobs["Agronomist"] = 63
	jobs["Librarian"] = 64
