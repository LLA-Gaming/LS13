...
/obj/machinery/door/airlock/clockwork/proc/attempt_construction(obj/item/I, mob/living/user)
	...
	if(istype(I, /obj/item/weapon/screwdriver))
		if(construction_state == GEAR_SECURE)
			...
			user.text2tab("<span class='warning'>The gear isn't secure enough to fasten!</span>")
		return 1
	else if(istype(I, /obj/item/weapon/wrench))
		if(construction_state == GEAR_SECURE)
			user.text2tab("<span class='warning'>[src] is too tightly secured! Your [I.name] can't get a solid grip!</span>")
			return 0
		else if(construction_state == GEAR_UNFASTENED)
		...
		if(construction_state == GEAR_SECURE || construction_state == GEAR_UNFASTENED)
			user.text2tab("<span class='warning'>[src]'s gear is too tightly secured! Your [I.name] can't reach under it!</span>")
			return 1
		else if(construction_state == GEAR_LOOSE)
