/proc/priority_announce(text, title = "", sound = 'sound/AI/attention.ogg', type)
	...
	else if(type == "Station Chief")
		announcement += "<h1 class='alert'>Station Chief Announces</h1>"
		news_network.SubmitArticle(text, "Station Chief's Announcement", "Station Announcements", null)
